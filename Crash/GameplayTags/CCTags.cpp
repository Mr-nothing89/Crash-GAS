...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CCTags::CCAbilities::Primary,"CCTags.CCAbilities.Primary","Tag for the primary ability");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CCTags::CCAbilities::Secondary,"CCTags.CCAbilities.Secondary","Tag for the secondary ability");
